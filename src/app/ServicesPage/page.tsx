    ...
    <main>  {/* Footnote 2 */}
      <Navbar />
        <div className="flex flex-col justify-center items-center h-screen  text-gray-800 text-2xl font-sans">
          <h1 className=" font-bold">Services Page</h1>
        </div>
      <Footer/>  {/* Footnote 3 */}
    </main>
  );
...
* =====================================================================
* Date Revised : 2024-06-13   (last date you made a code change)
...
* - First commant line
*   - Changed //Service Page to // Component Name: ServicesPage
* - changed component name from Page to ServicesPage
